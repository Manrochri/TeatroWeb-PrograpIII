        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="MantenimientoServlet" method="post" id="formCurso">
                    ...
                    <div class="mb-3">
                        <label for="precio" class="form-label">Precio(soles)</label>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm" onclick="editarCurso(<%= rsCursos.getInt("IdCurso") %>, '<%= rsCursos.getString("FechaRegistro") %>', '<%= rsCursos.getString("Capacidad") %>', '<%= rsCursos.getString("FechaInicio") %>', '<%= rsCursos.getString("FechaFin") %>', '<%= rsCursos.getString("Precio") %>', '<%= rsCursos.getString("IdCategoria") %>', '<%= rsCursos.getString("IdDuracion") %>', '<%= rsCursos.getString("IdIdioma") %>', '<%= rsCursos.getString("IdRango") %>')">Editar</button>
                        <form action="MantenimientoServlet" method="post" class="d-inline">
